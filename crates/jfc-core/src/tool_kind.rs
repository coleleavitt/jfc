...
impl ToolKind {
    pub fn from_name(name: &str) -> Self {
        return_tool_kind!(name,
            ...
            Self::BashOutput => ["bash_output", "bashoutput"],
            Self::Glob => ["glob"],
            Self::Grep => ["grep"],
            ...
            Self::GetProgramSlice => ["get_program_slice"],
            Self::GetDataDependencies => ["get_data_dependencies"],
    ...
    pub fn label(&self) -> &str {
        match self {
            ...
            Self::GetProgramSlice => "GetProgramSlice",
            Self::GetDataDependencies => "GetDataDependencies",
            Self::TaintFlow => "TaintFlow",
