    ...
    ChatMessage::assistant_parts(vec![
        ...
        MessagePart::tool_boxed(Box::new(ToolCall {
            ...
            input: ToolInput::Edit {
                file_path: "crates/jfc/src/tools.rs".into(),
        ...
        MessagePart::tool_boxed(Box::new(ToolCall {
            ...
            input: ToolInput::Bash {
                command: "cargo check -p jfc".into(),
                timeout: None,
                workdir: None,
        ...
        MessagePart::tool_boxed(Box::new(ToolCall {
            ...
            input: ToolInput::Read {
                file_path: "crates/jfc/src/main.rs".into(),
                offset: Some(1),
                limit: Some(80),
            },
            output: ToolOutput::FileContent {
                path: "crates/jfc/src/main.rs".into(),
                language: "rust".into(),
                content: "mod app;\nmod context;\n\nuse std::sync::Arc;\nuse tokio::sync::mpsc;"
                    .into(),
            },
        ...
        MessagePart::tool_boxed(Box::new(ToolCall {
            ...
            input: ToolInput::Write {
                file_path: "crates/jfc/src/tool_harness.rs".into(),
        ...
        MessagePart::tool_boxed(Box::new(ToolCall {
            ...
            input: ToolInput::ApplyPatch {
                patch: "*** Begin Patch\n*** Update File: crates/jfc/src/main.rs".into(),
            },
            output: ToolOutput::Diff(parse_unified_diff(
                "crates/jfc/src/main.rs",
                r#"@@ -10,1 +10,1 @@
-struct ChatMessage;
+enum MessagePart;
"#,
