...
pub fn execute_design_project_create(cwd: &Path, title: &str) -> ExecutionResult {
...
pub fn execute_design_project_list(cwd: &Path) -> ExecutionResult {
    let result: std::result::Result<String, String> = (|| {
        let store = store(cwd)?;
...
pub fn execute_design_project_set_meta(
    cwd: &Path,
    project_id: &str,
    title: Option<&str>,
...
pub fn execute_design_list_files(cwd: &Path, project_id: &str) -> ExecutionResult {
    let result: std::result::Result<String, String> = (|| {
        let store = store(cwd)?;
...
pub fn execute_design_write_file(
    cwd: &Path,
    project_id: &str,
    path: &str,
    content: &str,
...
pub fn execute_design_copy_file(
    cwd: &Path,
    project_id: &str,
    from_path: &str,
    to_path: &str,
...
pub fn execute_design_register_asset(
    cwd: &Path,
    project_id: &str,
    name: &str,
    path: &str,
...
pub fn execute_design_unregister_asset(
    cwd: &Path,
    project_id: &str,
    path: &str,
) -> ExecutionResult {
...
pub fn execute_design_bundle_html(
    input: &str,
    output: Option<&str>,
...
pub fn execute_design_check_system(project_dir: &str) -> ExecutionResult {
...
pub fn execute_design_capabilities(format: Option<&str>) -> ExecutionResult {
