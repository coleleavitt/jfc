...
pub const MAX_TOOL_RESULT_CHARS: usize = ToolOutput::APPROX_LEN_CAP;

/// Bytes shown at each end of a truncated tool result.
pub const TRUNCATION_PREVIEW_CHARS: usize = 2_000;
...
pub fn persist_tool_result(body: &str) -> String {
...
pub fn cap_tool_result(body: &str) -> String {
