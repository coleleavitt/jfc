...
pub fn is_server_tool(kind: &ToolKind) -> bool {
    matches!(
        kind,
...
pub fn tool_use_content(tc: &ToolCall, counters: &mut ToolWireCounters) -> ProviderContent {
...
pub fn server_tool_result_content(
    tc: &ToolCall,
