...
pub fn update_task_activities(state: &mut crate::app::EngineState, calls: &[types::ToolCall]) {
...
pub fn task_drift_reminder(state: &crate::app::EngineState) -> Option<String> {
