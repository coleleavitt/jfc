...
impl TextInput {
    ...
    pub fn new(
        ...
        Self {
            ...
            text_color,
            placeholder_color,
            selection_color: rgba(0x3366ff40),
            cursor_color,
        }
    }
...
impl Element for TextElement {
    ...
    fn prepaint(
        ...
        tracing::debug!(
            ...
            display_len,
            content_empty = input.content.is_empty(),
            cursor,
            cursor_x = ?cursor_pos,
    ...
    fn paint(
        ...
        tracing::debug!(
            ...
            has_line = prepaint.line.is_some(),
            has_cursor = prepaint.cursor.is_some(),
            has_selection = prepaint.selection.is_some(),
            "text input paint"
        );
        window.handle_input(
            &focus_handle,
